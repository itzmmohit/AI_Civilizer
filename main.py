...
def perdict_person():
    ...
    lab=Label(top, text="Personality AI-CV Analyser", foreground='red', bg='black', font=titleFont, pady=10).pack()
...
def OpenFile(b4):
    global loc;
    name = filedialog.askopenfilename(initialdir="C:/Users/Prajwal B K/Desktop/Personality-Prediction-Through-CV-master/Person-CV/Test Cases",
...
if __name__ == "__main__":
    ...
    root.title("Personality Prediction with AI-CVLizer System")
    titleFont = font.Font(family='Helvetica', size=25, weight='bold')
    homeBtnFont = font.Font(size=12, weight='bold')
    lab=Label(root, text="AI CVLizer with personality predictor System", bg='white', font=titleFont, pady=30).pack()
